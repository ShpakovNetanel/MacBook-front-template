...
export const ZToast = {
    Success: ({ slotProps, description = 'הפעולה הושלמה בהצלחה', title = 'הודעת הצלחה', icon }: ZToastProps) =>
        <ZToastBase
            title={title}
        ...
        />,
    Error: ({ slotProps, description = 'הפעולה נכשלה', title = 'הודעת שגיאה', icon }: ZToastProps) => 
    <ZToastBase
        title={title}
        description={description}
        slotProps={{
    ...
    />,
    Info: ({ slotProps, description = 'הפעולה חזרה עם התראה', title = 'פעולת אזהרה', icon }: ZToastProps) => 
    <ZToastBase
        title={title}
        description={description}
        slotProps={{
